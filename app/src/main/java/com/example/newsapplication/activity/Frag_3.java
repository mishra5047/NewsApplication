...
public class Frag_3 extends Fragment implements OnRecyclerViewItemClickedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        inflater.inflate(R.layout.frag_3_layout, container, false);
        final View view = inflater.inflate(R.layout.frag_3_layout, container, false);
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                if (response.body() != null && response.body().getStatus().equals("ok")) {
                    ...
                    if (articleList.size() > 0) {
                        ...
                        mainArticleAdapter.setOnRecyclerViewItemClickListener(Frag_3.this);
