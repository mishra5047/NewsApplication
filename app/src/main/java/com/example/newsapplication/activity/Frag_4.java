...
public class Frag_4 extends Fragment implements OnRecyclerViewItemClickedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        inflater.inflate(R.layout.frag_4_layout, container, false);
        final View view = inflater.inflate(R.layout.frag_4_layout, container, false);


        ApiInterface apiService = ApiClient.getClient().create(ApiInterface.class);
        Call<ResponseModel> call = apiService.getLatestNews("top-headlines/q=sports", API_KEY);
            ...
            public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                if (response.body() != null && response.body().getStatus().equals("ok")) {
                    ...
                    if (articleList.size() > 0) {
                        ...
                        final RecyclerView mainRecycler = view.findViewById(R.id.activity_main_rv_4);
                        ...
                        mainArticleAdapter.setOnRecyclerViewItemClickListener(Frag_4.this);
